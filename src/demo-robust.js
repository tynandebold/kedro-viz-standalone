export const demoRobust = {
  nodes: [
    ...
    },
    {
      ...
      layer: "raw",
      dataset_type:
        "shuttle_factory.utilities.io.tag_dict_datasets.CustomCSVDataSet",
    },
    {
      id: "c3f72bfd",
      name: "Enforce Schema",
    ...
    },
    {
      ...
      full_name:
        "train.create_features.factory_train_with_off_equipment_to_zero.static_features",
      tags: ["data-eng"],
      pipelines: ["__default__", "create_features"],
      type: "data",
      modular_pipelines: [
    ...
    },
    {
      ...
      name: "Static Features",
      full_name:
        "test.create_features.factory_test_with_off_equipment_to_zero.static_features",
      tags: ["data-eng"],
      pipelines: ["__default__", "create_features"],
      type: "data",
      modular_pipelines: [
    ...
    },
    {
      ...
      parameters: {
        ...
        "train_model.feature_selection": [
          ...
          {
            class:
              "shuttle_factory.utilities.core.transformers.feature_selection.SimpleNegControlSelector",
    ...
    },
    {
      ...
      parameters: {
        recommend: {
          solver: {
            class:
              "shuttle_factory.optimizer.solvers.DifferentialEvolutionSolver",
            kwargs: {
              sense: "maximize",
              seed: 0,
              maxiter: 50,
    ...
    {
      id: "6526dd55",
      name: "In Out Recent Clean",
      full_name: "in_out_recent_clean",
      tags: ["transcoding"],
      pipelines: ["transcoding_demo", "__default__"],
      type: "data",
      modular_pipelines: [],
    ...
    },
    {
      ...
      full_name: "factory.pandas_profiling",
      tags: [],
      pipelines: ["pandas_profiling", "__default__"],
    ...
    },
    {
      ...
      name: "Pandas Profiling",
      full_name: "in_out.pandas_profiling",
      tags: [],
      pipelines: ["pandas_profiling", "__default__"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "Impute",
      full_name: "factory_train.impute",
      tags: [],
      pipelines: ["impute_transform", "__default__"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "On Off Logic",
      full_name: "factory_test.on_off_logic",
      tags: [],
      pipelines: ["on_off_logic", "__default__"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "On Off Logic",
      full_name: "factory_train.on_off_logic",
      tags: [],
      pipelines: ["on_off_logic", "__default__"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      full_name: "test.create_features",
      tags: [],
      pipelines: ["__default__", "create_features"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "Create Features",
      full_name: "train.create_features",
      tags: [],
      pipelines: ["__default__", "create_features"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "In Out Train Imputed",
      full_name: "train.create_features.in_out_train_imputed",
      tags: [],
      pipelines: ["__default__", "create_features"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "In Out Test Imputed",
      full_name: "test.create_features.in_out_test_imputed",
      tags: [],
      pipelines: ["__default__", "create_features"],
      type: "modularPipeline",
      modular_pipelines: null,
    ...
    },
    {
      ...
      name: "Factory Test With Off Equipment To Zero",
      full_name: "test.create_features.factory_test_with_off_equipment_to_zero",
      tags: [],
      pipelines: ["__default__", "create_features"],
      type: "modularPipeline",
      modular_pipelines: null,
  ...
  pipelines: [
    { id: "pandas_profiling", name: "Pandas Profiling" },
    { id: "eda", name: "Eda" },
    { id: "split", name: "Split" },
    { id: "clean", name: "Clean" },
    { id: "impute_fit", name: "Impute Fit" },
    { id: "impute_transform", name: "Impute Transform" },
    { id: "on_off_logic", name: "On Off Logic" },
    { id: "create_features", name: "Create Features" },
    { id: "train_model", name: "Train Model" },
    { id: "recommend", name: "Recommend" },
    { id: "recommend_uplift_report", name: "Recommend Uplift Report" },
    { id: "recommend_sensitivity", name: "Recommend Sensitivity" },
    { id: "transcoding_demo", name: "Transcoding Demo" },
